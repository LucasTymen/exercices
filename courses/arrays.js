...
// creating and modify array's valors (Arrays with let and const)
...
chores.push("play with the cat", "feed the cat");
console.log(chores);
...
console.log("======= Step 3 =======")
console.log(groceryList)
groceryList.pop('bananas', 'coffee beans', 'brown rice');
